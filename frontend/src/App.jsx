...
const Header = () => (
  <header className="sticky top-0 z-50 bg-[#0b0f15]/80 backdrop-blur-xl border-b border-white/5">
    <div className="max-w-7xl mx-auto px-6 h-16 sm:h-24 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-2 text-[10px] tracking-[0.3em] text-indigo-400 font-bold uppercase bg-indigo-500/5 px-4 py-2 rounded-full border border-indigo-500/10">
        Intra-College Tech Fest 2026
      </div>
    </div>
  </header>
);
...
const EventCard = ({ event }) => {
  ...
  return (
    <div className="group relative bg-white/[0.02] border border-white/10 rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:border-indigo-500/40 hover:bg-white/[0.04] flex flex-col h-full shadow-2xl">
      {/* Image Container */}
  ...
  return (
    <div className="min-h-screen bg-[#06080c] text-slate-200 antialiased font-sans selection:bg-indigo-500/30 selection:text-white relative overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 lg:py-24 relative z-10">
        ...
        {/* Footer Note */}
        <div className="mt-20 flex flex-col items-center gap-4 opacity-40 hover:opacity-100 transition-opacity">
          <div className="w-12 h-[1px] bg-indigo-500/50" />
          <p className="text-[10px] font-bold tracking-[0.4em] uppercase text-indigo-300">
            Secure Google Forms Registration
          </p>
        </div>
      </main>
      ...
      <footer className="py-12 border-t border-white/5 bg-black/20 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-[10px] font-bold tracking-widest text-slate-500 uppercase">
            <a href="#" className="hover:text-indigo-400 transition-colors">Privacy</a>
            <a href="#" className="hover:text-indigo-400 transition-colors">Guidelines</a>
